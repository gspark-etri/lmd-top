...
| Store inventory / provenance | `model-inventory` cm | build path, size, compile target, and the toolchain the artifact records (`manifests/model-store-discovery.yaml` scans for it) |
